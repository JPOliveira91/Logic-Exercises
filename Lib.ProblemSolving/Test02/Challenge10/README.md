7 - Novamente, considerando a lista de pessoas do exemplo anterior, escreva um trecho de código utilizando linq (.NET) que retorne a soma das idades de todas as pessoas de Dallas
